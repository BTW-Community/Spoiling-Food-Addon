...
@Mixin({BucketBlockMilk.class, BucketBlockChocolateMilk.class})
public abstract class BucketBlockMilkMixin extends Block {
    protected BucketBlockMilkMixin(int par1, Material par2Material) {
    ...
    public void updateTick(World world, int i, int j, int k, Random rand) {
        if (world.getBlockId(i, j, k) == this.blockID) {
            ...
            //if ((extra >> 1) > FoodSpoilMod.PLANT_SPOIL_AGE) {
                ...
                // Kill the plant
                world.setBlockAndMetadataWithNotify(i, j, k, BTWBlocks.placedBucket.blockID, world.getBlockMetadata(i, j, k));
